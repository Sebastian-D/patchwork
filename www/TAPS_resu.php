<center><h3>Plots of TAPS_plot()</h3></center>
...
<center><h4>Bottom half of the plot</h4></center>
...
<center><h3>Chromosomal plots</h3></center>
...
<center><h3>Plots of TAPS_call()</h3></center>
...
<center><h3>Chromosomal plots with total and minor copynumbers</h3></center>
...
<center><h4>Left half of the plot</h4></center>
...
<center><h4>Right half of the plot</h4></center>
...
chromsome in question as their x axis.<br /><br />


<hr class="alt1" />

<center><h3>TAPS_Region()</h3></center>

TAPS_region() is used to take a closer look at a specific region of the genome. Additionally it displays known genes
of this region. The current gene list is the UCSC known gene list, hg18 & hg19, of march 2014.
...
<img id="fig6taps" src="css/img/6295_chr1_region_18000000-23000000.jpeg" alt="Example of TAPS_region output"
 title="Figure 6 TAPS"
 style="width:880px;"><br /><br />

Most of the content of the plot has been discussed above. Unique to the TAPS_region() output is the red "Selected region" marker
on the whole chromosome view, which spans logRatio, cytoband information and allele frequency.
This selected region is then shown in the bottom half of the plot, with an additional row of known gene information.<br />
Notice that you chose the size of the region. Larger regions will have gene information that is hard to discern whereas very small
regions might seem void of content. About 5 million basepairs, as seen here, or smaller is recommended.
